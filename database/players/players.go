...
func main() {
	...
	defer db.Close()
	absPath, err := filepath.Abs("database/players/understat_player.csv")
if err != nil {
	log.Fatal(err)
}
file, err := os.Open(absPath)
	...
	for {
		...
		stmt, err := db.Prepare("INSERT INTO player(player_link_id, player_name, team_name, team_id) VALUES ($1, $2, $3, $4)")
		if err != nil {
			log.Fatal(err)
		}
